export default function CardSkeleton(){
    return (
        <div className="flex flex-wrap gap-4 md:gap-10 justify-center items-center mt-10">
            {[1, 2, 3, 4].map(id => (
                <div role="status" className="p-4 w-[300px] rounded border border-gray-200 shadow animate-pulse md:p-6 dark:border-gray-700" key={id}>
